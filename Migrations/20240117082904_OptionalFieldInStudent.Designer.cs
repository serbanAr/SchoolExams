...
namespace SchoolExams.Migrations
{
    ...
    [Migration("20240117082904_OptionalFieldInStudent")]
    partial class OptionalFieldInStudent
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CourseEnrollment", b =>
                {
                    ...
                    b.HasKey("CoursesId", "EnrollmentsId");
            ...
            modelBuilder.Entity("CourseEnrollment", b =>
                {
                    b.HasOne("SchoolExams.Models.Course", null)
                        .WithMany()
                        .HasForeignKey("CoursesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SchoolExams.Models.Enrollment", null)
                        .WithMany()
            ...
            modelBuilder.Entity("EnrollmentStudent", b =>
                {
                    ...
                    b.HasOne("SchoolExams.Models.Student", null)
                        .WithMany()
